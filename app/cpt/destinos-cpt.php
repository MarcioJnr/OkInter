...
function create_destino_tax() {

	$labels = array(
		'name'              => _x( 'tipos', 'taxonomy general name', 'textdomain' ),
		'singular_name'     => _x( 'tipo', 'taxonomy singular name', 'textdomain' ),
		'search_items'      => __( 'Pesquisar tipos', 'textdomain' ),
		'all_items'         => __( 'Todas as tipos', 'textdomain' ),
		'parent_item'       => __( 'Pais de tipos', 'textdomain' ),
		'parent_item_colon' => __( 'Pais de tipos:', 'textdomain' ),
		'edit_item'         => __( 'Editar tipo', 'textdomain' ),
		'update_item'       => __( 'Atualizar tipo', 'textdomain' ),
		'add_new_item'      => __( 'Adicionar nova tipo', 'textdomain' ),
		'new_item_name'     => __( 'Adicionar novo nome de tipo', 'textdomain' ),
	...
	register_taxonomy( 'tipo', array('destino', 'destinos'), $args );

}
add_action( 'init', 'create_destino_tax' );
?>