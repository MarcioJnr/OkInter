    ...
    <div class="container ">
      <div class="row">
        <div class="col-12 col-md-6 col-xl-6">
          <h3 class="mb-5 cor-empresa">Fale conosco</h3>
          <p>
          A agência OK Intercâmbio é uma empresa especializada em oferecer serviços voltados para programas de estudos no exterior.  Se você deseja uma cotação de passagens aéreas  clica aqui.
          </p>
          <p>
      ...
      <div class="row">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.188549014864!2d-46.66056398507047!3d-23.561670784682832!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59ce80b64829%3A0x9fa8db6c12e1f60e!2sVIP%20OFFICE%20Coworking%20-%20Paulista%201!5e0!3m2!1spt-BR!2sbr!4v1647903900572!5m2!1spt-BR!2sbr" width="450" height="290" style="border:2px solid #FF6A2E; box-shadow: 5px 5px 5px gray;" allowfullscreen="" loading="lazy" class="col-12 col-md-12 col-xl-12 mb-4 rounded-3"></iframe>
          <h6 class="text-center">São Paulo, SP</h5>
          <div class="row">
          <div class="col-12 col-md-6 col-sm-12 text-center">
              <img src="<?php echo get_template_directory_uri( );?>/assets/icons/icone-local.svg" class=""> 
