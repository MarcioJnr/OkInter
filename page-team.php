...
<div class="container p-5">
        ...
        <div class="row text-center mt-4">
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
            <img src="<?php echo get_template_directory_uri(  );?>/assets/images/daniel.png" style="width: 200px; height: 200px;" class="mb-3" >
                <p class="fw-bold">Nome Sobrenome</p>
                <p class="mb-4">Cargo</p>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
            <img src="<?php echo get_template_directory_uri(  );?>/assets/images/maria.png" style="width: 200px; height: 200px;" class="mb-3" >
                <p class="fw-bold">Nome Sobrenome</p>
                <p class="mb-4">Cargo</p>
            </div>
            <div class="col-12 col-md-6 col-lg-6 col-xl-3">
            <img src="<?php echo get_template_directory_uri(  );?>/assets/images/joao.png" style="width: 200px; height: 200px;" class="mb-3" >
                <p class="fw-bold">Nome Sobrenome</p>
                <p class="mb-4">Cargo</p>
            </div>
        </div>
