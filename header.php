...
<body>
  ...
  <nav class="navbar navbar-light bg-light sticky-top" style=" width: 80%; margin: 0 auto; ">
    <div class="container-fluid">
      <a class="navbar-brand"></a>
      <form class="d-flex" style="margin-right: 9px;">
        <a href="" class="text-decoration-none"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light text-uppercase  navbar-light bg-light"
      ...
      <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="<?php get_template_directory_uri(  ) .'/assets/images/logok.png'?>" alt="LOGO" width="100px"></a>
