                ...
                <div class="d-flex flex-column flex-lg-row">
                  ...
                  <div class="carousel-info w-100 px-3 d-flex flex-column justify-content-center text-center text-lg-start">
                    ...
                    <span class="w-100 d-flex justify-content-center">
                      <a href="#modal-cotacao" data-bs-toggle="modal" data-bs-target="#modal-cotacao" class="btn w-100 text-white mb-3" id="btn-cotacao">Realizar cotação</a>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="carousel-item">
                ...
                <div class="d-flex flex-column flex-lg-row">
                  ...
                  <div class="carousel-info w-100 px-3 d-flex flex-column justify-content-center text-center text-lg-start">
                    ...
                    <span class="w-100 d-flex justify-content-center">
                      <a href="#modal-cotacao" data-bs-toggle="modal" data-bs-target="#modal-contact" class="btn w-100 text-white mb-3" id="btn-cotacao">Falar consultor</a>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="carousel-item active" id="hospedagem">
                ...
                <div class="d-flex flex-column flex-lg-row">
                  ...
                  <div class="carousel-info w-100 px-3 d-flex flex-column justify-content-center text-center text-lg-start">
                    ...
                    <span class="w-100 d-flex justify-content-center">
                      <a href="#modal-cotacao" data-bs-toggle="modal" data-bs-target="#modal-contact" class="btn w-100 text-white mb-3" id="btn-hospedagem">Falar consultor</a>
                    </span>
                  </div>
                </div>
              </div>
